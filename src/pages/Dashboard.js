...
const styles = {
    ...
    headerLogo: { height: '52px', width: '52px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0, 0, 0, 0.15)', },
    subTabsContainer: { position: 'fixed', top: '80px', left: 0, right: 0, zIndex: 999, background: 'rgba(255, 255, 255, 0.95)', backdropFilter: 'blur(10px)', boxShadow: '0 2px 12px rgba(0,0,0,0.08)', borderBottom: '1px solid rgba(234, 234, 234, 0.8)', },
    inventorySubTabs: { display: "flex", overflowX: "auto", padding: '0 32px', },
    inventorySubTab: { padding: "16px 24px", cursor: "pointer", fontSize: "14px", fontWeight: "500", color: "#64748b", whiteSpace: "nowrap", borderBottom: '3px solid transparent', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', position: 'relative', },
    activeInventorySubTab: { color: themeColors.primary, fontWeight: "700", borderBottom: `3px solid ${themeColors.primary}`, background: 'rgba(0, 161, 255, 0.05)', },
    inventoryContent: { width: "100%", background: "#fff", borderRadius: "12px", boxShadow: "0 2px 16px rgba(0,0,0,0.06)", overflow: 'hidden', },
    ...
    loadingSpinner: { border: `4px solid rgba(0, 161, 255, 0.1)`, borderTop: `4px solid ${themeColors.primary}`, borderRight: `4px solid ${themeColors.secondary}`, borderRadius: "50%", width: "60px", height: "60px", animation: "spin 1s linear infinite, color-rotate 2s linear infinite", marginBottom: "24px" },
    loadingText: { fontSize: "16px", fontWeight: "600", color: "#64748b", },
    accessDenied: { textAlign: "center", color: themeColors.danger, fontSize: "18px", padding: "48px", background: "#fff", borderRadius: "12px", fontWeight: "600", },
    popupOverlay: { position: "fixed", top: 0, left: 0, width: "100vw", height: "100vh", background: "rgba(0,0,0,0.75)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 2002, padding: "20px", boxSizing: "border-box", backdropFilter: 'blur(4px)', },
    popupBox: { width: "100%", maxWidth: "640px", padding: "40px", background: "#fff", borderRadius: "20px", textAlign: "center", display: "flex", flexDirection: "column", gap: "24px", maxHeight: "90vh", overflowY: "auto", boxShadow: '0 20px 60px rgba(0, 0, 0, 0.3)', },
    welcomeTitle: { margin: "0", color: "#1e293b", fontSize: "32px", fontWeight: "800", letterSpacing: '-0.5px', },
    welcomeText: { margin: "0", color: "#64748b", fontSize: "16px", fontWeight: "500", },
    videoWrapper: { margin: "20px 0", borderRadius: "16px", overflow: "hidden", position: "relative", paddingTop: "56.25%", boxShadow: '0 8px 24px rgba(0, 0, 0, 0.15)', },
    popupBoxiframe: { position: "absolute", top: 0, left: 0, width: "100%", height: "100%" },
    gotItBtn: { marginTop: "10px", padding: "16px 32px", border: "none", borderRadius: "12px", background: `linear-gradient(135deg, ${themeColors.success} 0%, #059669 100%)`, color: "#fff", cursor: "pointer", fontSize: "16px", fontWeight: "700", transition: 'all 0.3s ease', boxShadow: '0 4px 16px rgba(16, 185, 129, 0.3)', },
    loginPopupBox: { width: "100%", maxWidth: "420px", padding: "40px", background: "#fff", borderRadius: "20px", textAlign: "center", display: "flex", flexDirection: "column", gap: "20px", boxSizing: "border-box", boxShadow: '0 20px 60px rgba(0, 0, 0, 0.3)', },
    loginTitle: { margin: "0", color: "#1e293b", fontSize: "28px", fontWeight: "800", letterSpacing: '-0.5px', },
    loginInput: { padding: "16px 18px", border: "2px solid #e2e8f0", borderRadius: "12px", fontSize: "15px", outline: "none", transition: 'all 0.3s ease', fontWeight: "500", },
    loginButtons: { display: "flex", flexDirection: "column", gap: "12px", marginTop: "8px" },
    loginBtn: { padding: "16px", border: "none", borderRadius: "12px", background: `linear-gradient(135deg, ${themeColors.primary}, ${themeColors.secondary})`, color: "#fff", cursor: "pointer", fontSize: "16px", fontWeight: "700", transition: 'all 0.3s ease', boxShadow: '0 4px 16px rgba(0, 161, 255, 0.3)', },
...
styleSheet.innerText = `
  ...
  @keyframes color-rotate { 0% { border-top-color: ${themeColors.primary}; border-right-color: ${themeColors.secondary}; } 50% { border-top-color: ${themeColors.secondary}; border-right-color: ${themeColors.primary}; } 100% { border-top-color: ${themeColors.primary}; border-right-color: ${themeColors.secondary}; } }
  button:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(0, 0, 0, 0.15); }
  input:focus { border-color: ${themeColors.primary}; box-shadow: 0 0 0 3px rgba(0, 161, 255, 0.1); }
